...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="{{ route('projects.show', $project) }}" class="btn btn-info">Ver Proyecto</a>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Editar Información del Proyecto</h5>
    </div>
    <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                               id="nombre" name="nombre" value="{{ old('nombre', $project->nombre) }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('fecha_inicio') is-invalid @enderror" 
                               id="fecha_inicio" name="fecha_inicio" value="{{ old('fecha_inicio', $project->fecha_inicio) }}" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('estado') is-invalid @enderror" id="estado" name="estado" required>
                            ...
                            <option value="Planificación" {{ old('estado', $project->estado) == 'Planificación' ? 'selected' : '' }}>Planificación</option>
                            <option value="En Progreso" {{ old('estado', $project->estado) == 'En Progreso' ? 'selected' : '' }}>En Progreso</option>
                            <option value="En Revisión" {{ old('estado', $project->estado) == 'En Revisión' ? 'selected' : '' }}>En Revisión</option>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('responsable') is-invalid @enderror" 
                               id="responsable" name="responsable" value="{{ old('responsable', $project->responsable) }}" 
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control @error('monto') is-invalid @enderror" 
                           id="monto" name="monto" value="{{ old('monto', $project->monto) }}" 
